...
public class GetThuocNoiTruAction extends Action {
        ...
        try {
            ...
            if (listTNT != null) {
    			for (ThuocNoiTru tnt : listTNT) {
    				...
    				buf.append("<THUOC_NOI_TRU MAPHU='' THUOCNOITRU_MA='" + ma +
    	                    "' HSBA_SOVAOVIEN='" + sovaovien +
    	                    "' THUOCNOITRU_MAPHIEU='" + maphieu +
    	                    "' THUOCNOITRU_KHOA='" + khoa +
    	                    "' THUOCNOITRU_PHONG='" + phong +
    	                    "' THUOCNOITRU_BOSUNG='" + bosung +
    	                    "' THUOCNOITRU_NGAYGIO='" + ngaygio +
    	                    "' THUOCNOITRU_MATHUOC='" + mathuoc +
    	                    "' THUOCNOITRU_MAPHONG='" + maphong +
    	                    "' THUOCNOITRU_QUOCGIA='" + quocgia +
    	                    "' THUOCNOITRU_NGUON='" + nguon +
    	                    "' THUOCNOITRU_PHANLOAI='" + phanloai +
    	                    "' THUOCNOITRU_LOAI='" + loai +
    	                    "' THUOCNOITRU_YEUCAU='" + yeucau +
    	                    "' THUOCNOITRU_MIEN='" + mien +
    	                    "' THUOCNOITRU_NHI='" + nhi +
    	                    "' THUOCNOITRU_LAO='" + lao +
    	                    "' THUOCNOITRU_SOLUONG='" + soluong +
    	                    "' THUOCNOITRU_TRA='" + tra +
    	                    "' THUOCNOITRU_DONGIA='" + dongia +
    	                    "' THUOCNOITRU_DONGIABH='" + dongiabh +
    	                    "' THUOCNOITRU_NGAYTT='" + ngaytt +
    	                    "' THUOCNOITRU_CUM='" + cum +
    	                    "' THUOCNOITRU_LANLINH='" + lanlinh +
    	                    "' THUOCNOITRU_HANGSX='" + hangsx +
    	                    "' THUOCNOITRU_SODANGKY='" + sodangky +
    	                    "' THUOCNOITRU_KHONGTHU='" + khongthu +
    	                    "' THUOCNOITRU_BACSI='" + bacsi +
    	                    "' THUOCNOITRU_KHO='" + kho +
    	                    "' THUOCNOITRU_STATUS='" + status +
    	                    "' THUOCNOITRU_NGAYINLINH='" + ngayinlinh +
    	                    "' THUOCNOITRU_LANINTRA='" + lanintra +
    	                    "' THUOCNOITRU_NGAYINTRA='" + ngayintra +
    	                    "' THUOCNOITRU_DONGIANHAP='" + dongianhap +
    	                    "' THUOCNOITRU_DONGIABAN='" + dongiaban +
    	                    "' THUOCNOITRU_NGAYGIOCN='" + ngaygiocn +
    	                    "' THUOCNOITRU_NHANVIENCN='" + nhanviencn +
    	                    "' THUOCNOITRU_THUNGAN='" + thungan +
    	                    "' THUOCNOITRU_STT='" + sott +  "' />");
    			}
    		}
