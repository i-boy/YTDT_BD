...
public class GetTonKhoBHYTAction extends Action {
	...
	public String performAction(String request) throws Exception {
		...
		if (listTonKho != null) {
			for (TonKho tonkho : listTonKho) {
				buf.append("<record  TonKhoMa='" + tonkho.getTonkhoMa() 
						+ "' TonKhoTon='"+ tonkho.getTonkhoTon()
						+ "' MaHang='"+ tonkho.getDmthuocMaso().getDmthuocMa() 
						+ "' TenHang='"+ tonkho.getDmthuocMaso().getDmthuocTen() 
						+ "' QuocGiaSx='"+ tonkho.getDmquocgiaMaso().getDmquocgiaTen() 
						+ "' HangSx='"+ tonkho.getDmnhasanxuatMaso().getDmnhasanxuatTen()
						+ "' DonGia='"+ tonkho.getTonkhoDongiaban() + "' />");
			}
		}
		buf.append("</list>");
