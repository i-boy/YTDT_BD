...
public class MyMenuYTDTAction implements Serializable{
	...
	public static String kiemTraMenuCapCuu = "YES";//IConstantsRes.MENU_CAP_CUU.trim();
...
//	public Boolean CheckMenuCapCuu() {
//		if ( "YES".equalsIgnoreCase(IConstantsRes.MENU_CAP_CUU.trim())){
//			return true;
//		}
//		return false;
//	}
	...
	public String TiepDon_TiepDonBenhNhan_DangKyKhamBenh () {
		tenChuongTrinh = tiepNhanKhamBenh; 
	...
	public void setTiepNhanKhamBenh(String tiepNhanKhamBenh) {
		this.tiepNhanKhamBenh = tiepNhanKhamBenh;
	}
	...
	public void setVienPhiTaiKhoa(String vienPhiTaiKhoa) {
		this.vienPhiTaiKhoa = vienPhiTaiKhoa;
	}
	...
	public void setBaoCaoVienPhi(String baoCaoVienPhi) {
		this.baoCaoVienPhi = baoCaoVienPhi;
	}
	...
	public void setQuanLyKhoChinh(String quanLyKhoChinh) {
		this.quanLyKhoChinh = quanLyKhoChinh;
	}
	...
	public void setQuanLyKhoBHYT(String quanLyKhoBHYT) {
		this.quanLyKhoBHYT = quanLyKhoBHYT;
	}
