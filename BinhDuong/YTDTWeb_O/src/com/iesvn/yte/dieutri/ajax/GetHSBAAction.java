...
public class GetHSBAAction extends Action {
    ...
    public String performAction(String request) {
        ...
        try {
            ...
            String bophan = "";//hsba.getHsbaBophan() == null ? "" : hsba.getHsbaBophan();
            ...
            String nang = hsba.getHsbaNang() == null ? "" : hsba.getHsbaNang().toString();
         	String kncc = "";//hsba.getHsbaKncc() == null ? "" : hsba.getHsbaKncc().toString();
         	String ngaynop = "";
         	String ngaygiao = "";
         	...
         	String trluong = "";//hsba.getHsbaTrluong() == null ? "" : hsba.getHsbaTrluong().toString();
         	...
         	String vungton = "";//hsba.getHsbaVungton() == null ? "" : hsba.getHsbaVungton();
            ...
            /*
            if (hsba.getHsbaNgaybc() != null) {
                SimpleDateFormat df = new SimpleDateFormat("dd/MM/yyyy");
                Date cal = hsba.getHsbaNgaybc();
                ngaybc = df.format(cal);
            } 
            if (hsba.getHsbaNgaycappt() != null) {
                SimpleDateFormat df = new SimpleDateFormat("dd/MM/yyyy");
                Date cal = hsba.getHsbaNgaycappt();
                ngaycappt = df.format(cal);
            } 
            */
            buf.append("<HSBA MAPHU='' HSBA_SOVAOVIEN='" + hsba.getHsbaSovaovien() +
                    "' TIEPDON_MA='" + tiepdonma +
                    "' BENHNHAN_MA='" + benhnhanma +
                    "' HSBA_DONVIGOI='" + donvigoi +
                    "' HSBA_NGAYGIOVAOV='" + ngaygiovaov +
                    "' HSBA_NGAYGIORAV='" + ngaygiorav +
                    "' HSBA_NGAYGIOTV='" + ngaygiotv +
                    "' HSBA_CHANDOANBD='" + chandoanbd +
                    "' HSBA_MACHDOANTUYENT='" + machandoantt + 
                    "' HSBA_DIENGIAITUYENT='" + dgtt +
                    "' HSBA_MACHDOANBD='" + machandoanbd +
                    "' HSBA_DIENGIAIBD='" + dgbd +
                    "' TAINAN_MA='" + tainan +
                    "' HSBA_THANHTOANTN='" + thanhtoantn +
                    "' PHUONGTIEN_MA='" + phuongtien +
                    "' HSBA_NGUYENNHAN='" + nguyennhan +
                    "' DIADIEM_MA='" + diadiem +
                    "' HSBA_BOPHAN='" + bophan +
                    "' HSBA_CAPCUU='" + capcuu +
                    "' DOITUONG_MA='" + doituong +
                    "' HSBA_BENHSU='" + benhsu +
                    "' HSBA_RUOUBIA='" + ruoubia +
                    "' HSBA_TIEPNHAN='" + tiepnhan +
                    "' HSBA_DIEUTRI='" + dieutri +
                    "' HSBA_KETQUA='" + ketqua +
                    "' HSBA_TUVONG='" + tuvong +
                    "' HSBA_TUVVONG24G='" + tuvong24h +
                    "' HSBA_MUON='" + muon +
                    "' HSBA_NANG='" + nang +
                    "' HSBA_KNCC='" + kncc +
                    "' HSBA_NGAYNOP='" + ngaynop +
                    "' HSBA_NGAYGIAO='" + ngaygiao +
                    "' HSBA_MASOGIAO='" + masogiao +
                    "' HSBA_NHOMMAU='" + nhommau +
                    "' HSBA_RH='" + rh +
                    "' HSBA_TRLUONG='" + trluong +
                    "' NOISINH_MA='" + noisinh +
                    "' HSBA_NGAYGIOCN='" + ngaygiocn +
                    "' NHANVIEN_MA='" + nhanvien +
                    "' HSBA_NGAYBC='" + ngaybc +
                    "' HSBA_BAOTIN='" + baotin +
                    "' HSBA_LYDOVAO='" + lydovao +
                    "' HSBA_VUNGTON='" + vungton +
                    "' HSBA_DIENGIAITV='" + dgtv +
                    "' HSBA_TITRCHVI='" + tinhtrangcv +
                    "' HSBA_HANHCHANH='" + hanhchanh +
                    "' HSBA_CHMON='" + chmon +
                    "' HSBA_NGAYCAPPT='" + ngaycappt +
                    "' HSBA_KHOADANGDT='" + khoadangdt +
                    "' HSBA_KHOAVAOV='" + khoavaov +
                    "' HSBA_KHOARAV='" + khoarav +
                    "' HSBA_CHANDOANRAV='" + chandoanrav +
                    "' HSBA_DONGY='" + dongy  + "'>");
            ...
            try {
                ...
                String noisinhbn = "";//bn.getBenhnhanNoisinh() == null ? "" : bn.getBenhnhanNoisinh().getDtdmnoisinhMa();
                ...
                if (bn.getBenhnhanNgaysinh() != null) {
                    ...
                    ngaysinh = df.format(cal.getTime());
            	   	...
            	   	if (bn.getBenhnhanNgaygiocn() != null) {
                        ...
                        ngaygiocnbn = df.format(cal.getTime());
                    }
                ...
                buf.append("<BENH_NHAN MAPHU='' BENHNHAN_MA='" + bn.getBenhnhanMa() +
                        ...
                        "' BENHNHAN_NGHE='" + nghe +
                        "' BENHNHAN_NOISINH='" + noisinhbn +
                        "' BENHNHAN_LANVAO='" + lanvao +
                        "' BENHNHAN_NGAYGIOCN='" + ngaygiocnbn +
                        "' NHANVIEN_MA='" + nhanvienbn + "' />");
            ...
            try {
                ...
                if (hsbabhyt.getHsbabhytGiatri0() != null) {
             	...
             	if (hsbabhyt.getHsbabhytNgayghithe() != null) {
                    ...
                    ngayghithe = df.format(cal.getTime());
                }
             	if (hsbabhyt.getHsbabhytNgaytrathe() != null) {
                    SimpleDateFormat df = new SimpleDateFormat("dd/MM/yyyy");
                    Date cal = hsbabhyt.getHsbabhytNgaytrathe();
                    ngaytrathe = df.format(cal.getTime());
                }
             	if (hsbabhyt.getHsbabhytNgaygiocn() != null) {
                    SimpleDateFormat df = new SimpleDateFormat("dd/MM/yyyy");
                    Date cal = hsbabhyt.getHsbabhytNgaygiocn();
                    ngaygiocnbh = df.format(cal.getTime());
                }
                buf.append("<HSBA_BHYT MAPHU='' HSBABHYT_MA='" + hsbabhyt.getHsbabhytMa() +
                        "' HSBA_SOVAOVIEN='" + sovaovien +
                        "' HSBABHYT_KHOIBH='" + khoibh +
                        "' HSBABHYT_TINHBH='" + tinhbh +
                        "' HSBABHYT_HUYENBH='" + huyenbh +
                        "' HSBABHYT_COQUANBH='" + coquanbh +
                        "' HSBABHYT_SOTHEBH='" + sothebh +
                        "' HSBABHYT_NAMBHYT='" + nambhyt +
                        "' HSBABHYT_NAMTG='" + namtg + 
                        "' HSBABHYT_GIATRI0='" + giatri0 +
                        "' HSBABHYT_GIATRI1='" + giatri1 +
                        "' HSBABHYT_GIATRI2='" + giatri2 +
                        "' HSBABHYT_GIATRI3='" + giatri3 +
                        "' HSBABHYT_TUYEN='" + tuyen +
                        "' HSBABHYT_MAKCB='" + makcb +
                        "' HSBABHYT_NGAYGHITHE='" + ngayghithe +
                        "' HSBABHYT_NGAYTRATHE='" + ngaytrathe +
                        "' HSBABHYT_NGAYGIOCN='" + ngaygiocnbh +
                        "' HSBABHYT_NHANVIEN_MA='" + nhanviencn +
                        "' HSBABHYT_SOTHETE='" + sothete +
                        "' HSBABHYT_SOTHENGHEO='" + sothengheo +
                        "' HSBABHYT_KHAISINH='" + khaisinh +
                        "' HSBABHYT_CHUNGSINH='" + chungsinh +
                        "' HSBABHYT_CNXA='" + cnxa +
                        "' HSBABHYT_GIAMHO='" + giamho +
                        "' HSBABHYT_XNMIENTN='" + xnmientn +
                        "' HSBABHYT_TYLEBH='" + tylebh + "' />");
