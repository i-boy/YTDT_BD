...
public class SetInforUtil {
	...
	public static void setInforIfNullForThuocPhongKham(ThuocPhongKham thuocPhongKham) {
		...
		if (thuocPhongKham.getThuocphongkhamMathuoc().getDmdonvitinhMaso() == null) {
			thuocPhongKham.getThuocphongkhamMathuoc().setDmdonvitinhMaso(
					new DmDonViTinh());
		}
	...
	public static void setInforIfNullForHsbaChuyenVien(
			HsbaChuyenVien hsbaChuyenvien2) {
		log.info("Begin setInforIfNullForHsba():");
		try {
			...
			// if (hsbaChuyenvien2.getKhoaMa() == null) {
			// hsbaChuyenvien2.setKhoaMa(new DmKhoa());
			// }
	...
	public static void setInforIfNullForCTPhieuDuTru(CtPhieuDt ctPhieuDuTru) {
		...
		// dmThuoc.setDtdmdonvitinhMa(dtDmDonViTinh);
		...
		// if (ctPhieuDuTru.getDmkhoaNhan() == null) {
		// ctPhieuDuTru.setDmkhoaNhan(new DmKhoa());
		// }
		// if (ctPhieuDuTru.getDmkhoaXuat() == null) {
		// ctPhieuDuTru.setDmkhoaXuat(new DmKhoa()) ;
		// }
		if (ctPhieuDuTru.getDmnguonkinhphiMaso() == null) {
			ctPhieuDuTru.setDmnguonkinhphiMaso(new DmNguonKinhPhi());
		}
		// if (ctPhieuDuTru.getDmphanloaithuocMaso() == null) {
		// ctPhieuDuTru.setDmphanloaithuocMaso(new DmPhanLoaiThuoc());
		// }
		...
		// if (ctPhieuDuTru.getDmloaiMa1() == null) {
		// ctPhieuDuTru.setDmloaiMa1(new DmLoaiThuoc());
		// }
		// if (ctPhieuDuTru.getDmloaiMa2() == null) {
		// ctPhieuDuTru.setDmloaiMa2(new DmLoaiThuoc());
		// }
	...
	public static void setInforIfNullForPhieuDuTru(PhieuDuTru phieuDuTru) {
		...
		try {
			...
			/*
			 * if (phieuDuTru.getDmnguonkinhphiMaso() == null ) {
			 * phieuDuTru.setDmnguonkinhphiMaso(new DmNguonKinhPhi()); } if
			 * (phieuDuTru.getDmnctMaso() == null) { phieuDuTru.setDmnctMaso(new
			 * DmNguonChuongTrinh()); } if (phieuDuTru.getPheudtNhapphieu() ==
			 * null) { phieuDuTru.setPheudtNhapphieu(new DtDmNhanVien()); }
			 */
		} catch (Exception ex) {
...
/*	public static void setInforIfNullForPhieuBaoAn(PhieuBaoAn object){
		if (object.getKhoaMaso() == null) {
			object.setKhoaMaso(new DmKhoa());
		}

		if (object.getMucanMaso() == null) {
			object.setMucanMaso(new DtDmMucAn());
		}

		if (object.getLoaianMaso() == null) {
			object.setLoaianMaso(new DtDmLoaiAn());
		}

		if (object.getChedoanMaso() == null) {
			object.setChedoanMaso(new DtDmCheDoAn());
		}

		if (object.getPhongMaso() == null) {
			object.setPhongMaso(new DtDmPhong());
		}

		if (object.getNhanvienDuyetMaso() == null) {
			object.setNhanvienDuyetMaso(new DtDmNhanVien());
		}
		
		if (object.getNhanvienNhapMaso() == null) {
			object.setNhanvienNhapMaso(new DtDmNhanVien());
		}
		
		if (object.getHsbaSovaovien() == null) {
			object.setHsbaSovaovien(new Hsba());
		}
	}
*/	
