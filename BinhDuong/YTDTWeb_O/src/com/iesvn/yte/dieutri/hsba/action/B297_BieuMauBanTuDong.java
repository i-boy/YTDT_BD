...
public class B297_BieuMauBanTuDong implements Serializable{
	...
	public void XuatReport() {
		...
		try {
			...
			Class.forName("oracle.jdbc.OracleDriver");
			    ...
			    baocao1=XuatReportUtil.ReportUtil(jasperPrintDT,index,IConstantsRes.PATH_BASE+IConstantsRes.PATH_REPORT_RESULT_DIEU_TRI+"hsba/", "pdf","BieuMauBanTuDong");
