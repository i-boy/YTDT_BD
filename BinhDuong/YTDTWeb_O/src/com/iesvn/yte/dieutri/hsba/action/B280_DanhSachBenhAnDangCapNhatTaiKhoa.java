...
@Scope(CONVERSATION)
public class B280_DanhSachBenhAnDangCapNhatTaiKhoa implements Serializable {
	/**
	 * 
	 */
	...
	public void XuatReport() {
		loaiBCDT="DanhSachBenhAnDangCapNhatTaiKhoa";
		log.info("Vao Method XuatReport DanhSachBenhAnDangCapNhatTaiKhoa");
		String baocao1=null;
		...
		try {
			...
			Class.forName("oracle.jdbc.OracleDriver");
			    ...
			    baocao1=XuatReportUtil.ReportUtil(jasperPrintDT,index,IConstantsRes.PATH_BASE+IConstantsRes.PATH_REPORT_RESULT_DIEU_TRI+"hsba/", "pdf","DanhSachBenhAnDangCapNhatTaiKhoa");
