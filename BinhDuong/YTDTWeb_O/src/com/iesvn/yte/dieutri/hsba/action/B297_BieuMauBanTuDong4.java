...
@Scope(CONVERSATION)
@Name("B297_BieuMauBanTuDong4")
@Synchronized(timeout = 6000000)
public class B297_BieuMauBanTuDong4 implements Serializable{

	private static final long serialVersionUID = -5106695460338085910L;
	private static Logger log = Logger.getLogger(B297_BieuMauBanTuDong4.class);
	...
	public void XuatReport() {
		...
		try {
			...
			Class.forName("oracle.jdbc.OracleDriver");
			    ...
			    baocao1=XuatReportUtil.ReportUtil(jasperPrintDT,index,IConstantsRes.PATH_BASE+IConstantsRes.PATH_REPORT_RESULT_DIEU_TRI+"hsba/", "pdf","BieuMauBanTuDong4");
