...
import com.iesvn.yte.dieutri.delegate.HsbaChiTietRhmDelegate;
...
@Scope(CONVERSATION)
@Name("B211_3_CapNhatThongTinRhm")
@Synchronized(timeout = 600000)
public class CapNhatThongTinChiTietBARhmAction implements Serializable {
	private static final long serialVersionUID = 10L;
	private transient static Logger log = Logger
			.getLogger(CapNhatThongTinChiTietBARhmAction.class);
	...
	private HsbaChiTietRhm hsbaCTRhm;
	...
	public String init() throws Exception {
		log.info("*** Starting init Chi tiet BA RHM ***");
		...
		if (hsbaChuyenMon != null) {
			...
			if (hsbaChuyenMon.getHsbaSovaovien() != null){
				...
				HsbaChiTietRhm hsbaCTRhmTemp = null;
				try {
					hsbaCTRhmTemp = HsbaChiTietRhmDelegate.getInstance().findByHsbaCM(hsbaChuyenMon.getHsbacmMa());
				} catch (Exception e) {
					log.info("error:" + e);
				}
				
				if (hsbaCTRhmTemp != null) {
					hsbaCTRhm = hsbaCTRhmTemp;
				} else {
					hsbaCTRhm = new HsbaChiTietRhm();
				}
	...
	public void ghinhan() {
		log.info("*** Starting ghinhan Chi tiet BA RHM ***");
		ghiNhanException = null;

		hsbaCTRhm.setHsbacmMa(hsbaChuyenMon);
		RemoveUtil.removeAllNullFromHSBACTRhm(hsbaCTRhm);

		if (hsbaCTRhm.getHsbactrhmMa() == null) {
			HsbaChiTietRhmDelegate.getInstance().create(hsbaCTRhm);
		} else {
			HsbaChiTietRhmDelegate.getInstance().edit(hsbaCTRhm);
		}
	...
	public void XuatReport() {
		loaiBCDT = "CapNhatThongTinChiTietBARhm";
		log.info("Vao Method XuatReport bao cao cap nhat thong tin chi tiet benh an RHM");
		String baocao1 = null;
		try {
			log.info("bat dau method XuatReport ");
			String pathTemplate = IConstantsRes.PATH_BASE + IConstantsRes.PATH_REPORT_TEMPLATE_DIEU_TRI + "hsba/benhanrhm_main.jrxml";
			String sub1Template = IConstantsRes.PATH_BASE + IConstantsRes.PATH_REPORT_TEMPLATE_DIEU_TRI + "hsba/benhanrhm_sub1.jrxml";
			String sub2Template = IConstantsRes.PATH_BASE + IConstantsRes.PATH_REPORT_TEMPLATE_DIEU_TRI + "hsba/benhanrhm_sub2.jrxml";
			String sub3Template = IConstantsRes.PATH_BASE + IConstantsRes.PATH_REPORT_TEMPLATE_DIEU_TRI + "hsba/benhanrhm_sub3.jrxml";
			String sub4Template = IConstantsRes.PATH_BASE + IConstantsRes.PATH_REPORT_TEMPLATE_DIEU_TRI + "hsba/benhanrhm_sub4.jrxml";

			String hinh1 = IConstantsRes.PATH_BASE + IConstantsRes.PATH_REPORT_TEMPLATE_DIEU_TRI + "hsba/img_benhanrhm.jpg";
			...
			try {
				...
				log.info("error Xuat Report HsbaChiTietRhmDelegate.getInstance().findByHsbaCM: " + e);
			}
...
//			}
			...
			if (hsbaCTRhm.getHsbactrhmCoquankhac() != null) {
				sBenhcoquankhac = hsbaCTRhm.getHsbactrhmCoquankhac();
			}
			params.put("BENHCOQUANKHAC", sBenhcoquankhac);

			String sChitietbenhcoquankhac = "";
			if (hsbaCTRhm.getHsbactrhmChitietbenhcoquankhac() != null) {
				sChitietbenhcoquankhac = hsbaCTRhm.getHsbactrhmChitietbenhcoquankhac();
			}
			params.put("CHITIETBENHCOQUANKHAC", sChitietbenhcoquankhac);

			// TT
			if (hsbaCTRhm.getHsbactrhmLydovaov() != null)
				params.put("LYDOVAOVIEN", hsbaCTRhm.getHsbactrhmLydovaov());
			if (hsbaCTRhm.getHsbactrhmNgaybenhthu() != null)
				params.put("VAONGAYTHU", hsbaCTRhm.getHsbactrhmNgaybenhthu());
			if (hsbaCTRhm.getHsbactrhmQtbenhly() != null)
				params.put("QTBENHLY", hsbaCTRhm.getHsbactrhmQtbenhly());
			if (hsbaCTRhm.getHsbactrhmTiensubenhbt() != null)
				params.put("TSBBANTHAN", hsbaCTRhm.getHsbactrhmTiensubenhbt());
			if (hsbaCTRhm.getHsbactrhmTiensubenhgd() != null)
				params.put("GIADINH", hsbaCTRhm.getHsbactrhmTiensubenhgd());
			
			if (hsbaCTRhm.getHsbactrhmDdDiung() != null && hsbaCTRhm.getHsbactrhmDdDiung() == true)
				params.put("DIUNG", "1");
			else
				params.put("DIUNG", "2");
			if (hsbaCTRhm.getHsbactrhmDdMatuy() != null && hsbaCTRhm.getHsbactrhmDdMatuy() == true)
				params.put("MATUY", "1");
			else
				params.put("MATUY", "2");
			if (hsbaCTRhm.getHsbactrhmDdRuoubia() != null && hsbaCTRhm.getHsbactrhmDdRuoubia() == true)
				params.put("RUOUBIA", "1");
			else
				params.put("RUOUBIA", "2");
			if (hsbaCTRhm.getHsbactrhmDdThuocla() != null && hsbaCTRhm.getHsbactrhmDdThuocla() == true)
				params.put("THUOCLA", "1");
			else
				params.put("THUOCLA", "2");
			if (hsbaCTRhm.getHsbactrhmDdThuoclao() != null && hsbaCTRhm.getHsbactrhmDdThuoclao() == true)
				params.put("THUOCLAO", "1");
			else
				params.put("THUOCLAO", "2");
			if (hsbaCTRhm.getHsbactrhmDdKhac() != null && hsbaCTRhm.getHsbactrhmDdKhac() == true)
				params.put("KHAC", "1");
			else
				params.put("KHAC", "2");

			// *** THOI GIAN
			if (hsbaCTRhm.getHsbactrhmDdDiungTg() != null)
				params.put("DIUNGTG", hsbaCTRhm.getHsbactrhmDdDiungTg());
			if (hsbaCTRhm.getHsbactrhmDdMatuyTg() != null)
				params.put("MATUYTG", hsbaCTRhm.getHsbactrhmDdMatuyTg());
			if (hsbaCTRhm.getHsbactrhmDdRuoubiaTg() != null)
				params.put("RUOUBIATG", hsbaCTRhm.getHsbactrhmDdRuoubiaTg());
			if (hsbaCTRhm.getHsbactrhmDdThuoclaTg() != null)
				params.put("THUOCLATG", hsbaCTRhm.getHsbactrhmDdThuoclaTg());
			if (hsbaCTRhm.getHsbactrhmDdThuoclaoTg() != null)
				params.put("THUOCLAOTG", hsbaCTRhm.getHsbactrhmDdThuoclaoTg());
			if (hsbaCTRhm.getHsbactrhmDdKhacTg() != null)
				params.put("KHACTG", hsbaCTRhm.getHsbactrhmDdKhacTg());

			if (hsbaCTRhm.getHsbactrhmToanthan() != null)
				params.put("TOANTHAN", hsbaCTRhm.getHsbactrhmToanthan());
			
			if (hsbaCTRhm.getHsbactrhmThantietnieusinhhoc() != null)
				params.put("THANTNSD", hsbaCTRhm.getHsbactrhmThantietnieusinhhoc());
			if (hsbaCTRhm.getHsbactrhmTuanhoan() != null)
				params.put("TUANHOAN", hsbaCTRhm.getHsbactrhmTuanhoan());
			if (hsbaCTRhm.getHsbactrhmHohap() != null)
				params.put("HOHAP", hsbaCTRhm.getHsbactrhmHohap());
			if (hsbaCTRhm.getHsbactrhmTieuhoa() != null)
				params.put("TIEUHOA", hsbaCTRhm.getHsbactrhmTieuhoa());
			
			if (hsbaCTRhm.getHsbactrhmThankinh() != null)
				params.put("THANKINH", hsbaCTRhm.getHsbactrhmThankinh());
			if (hsbaCTRhm.getHsbactrhmCoxuongkhop() != null)
				params.put("COXUONGKHOP", hsbaCTRhm.getHsbactrhmCoxuongkhop());
			if (hsbaCTRhm.getHsbactrhmTmh() != null)
				params.put("TMH", hsbaCTRhm.getHsbactrhmTmh());
			if (hsbaCTRhm.getHsbactrhmMat() != null)
				params.put("RHM", hsbaCTRhm.getHsbactrhmMat());
			
			
			if (hsbaCTRhm.getHsbactrhmBslamba() != null)
				params.put("BASILAMBA", hsbaCTRhm.getHsbactrhmBslamba(true).getDtdmnhanvienTen());

			String sNguoigiaoBa = "";
			String sNguoinhanBa = "";
			if (hsbaCTRhm.getHsbactrhmNguoigiaoba() != null) {
				sNguoigiaoBa = hsbaCTRhm.getHsbactrhmNguoigiaoba(true).getDtdmnhanvienTen();
			}
			if (hsbaCTRhm.getHsbactrhmNguoinhanba() != null) {
				sNguoinhanBa = hsbaCTRhm.getHsbactrhmNguoinhanba(true).getDtdmnhanvienTen();
			}
...
//				params.put("HUYETAP", hsbaChuyenMon.getHsbacmHamin() + " / " + hsbaChuyenMon.getHsbacmHamax());
			...
			if (hsbaCTRhm.getHsbactrhmNtDdBlk() != null)
				params.put("NTDDBLK", hsbaCTRhm.getHsbactrhmNtDdBlk());
			if (hsbaCTRhm.getHsbactrhmTtba() != null)
				params.put("TTBA", hsbaCTRhm.getHsbactrhmTtba());
			if (hsbaChuyenMon.getHsbacmHuongdieutri() != null)
				params.put("HUONGDT", hsbaChuyenMon.getHsbacmHuongdieutri());

			// *****PAGE 4*******//
			if (hsbaCTRhm.getHsbactrhmQtblDbls() != null)
				params.put("QTBLDBLS", hsbaCTRhm.getHsbactrhmTtba());
			if (hsbaCTRhm.getHsbactrhmTtkqxncls() != null)
				params.put("TTKQCLSCD", hsbaCTRhm.getHsbactrhmTtkqxncls());
			if (hsbaCTRhm.getHsbactrhmPpdieutri() != null)
				params.put("PPDT", hsbaCTRhm.getHsbactrhmPpdieutri());
			if (hsbaCTRhm.getHsbactrhmTtnguoibenhrav() != null)
				params.put("TTNBRV", hsbaCTRhm.getHsbactrhmTtnguoibenhrav());
			if (hsbaCTRhm.getHsbactrhmHuongdtCdtt() != null)
				params.put("HDTCCDTT", hsbaCTRhm.getHsbactrhmHuongdtCdtt());
			
			if (hsbaCTRhm.getHsbactrhmSotoxquang() != null)
				params.put("XQUANG", hsbaCTRhm.getHsbactrhmSotoxquang());
			if (hsbaCTRhm.getHsbactrhmSotoctscanner() != null)
				params.put("SCANNER", hsbaCTRhm.getHsbactrhmSotoctscanner());
			if (hsbaCTRhm.getHsbactrhmSotosieuam() != null)
				params.put("SIEUAM", hsbaCTRhm.getHsbactrhmSotosieuam());
			if (hsbaCTRhm.getHsbactrhmSotoxn() != null)
				params.put("XETNGHIEM", hsbaCTRhm.getHsbactrhmSotoxn());
			if (hsbaCTRhm.getHsbactrhmSotokhac() != null)
				params.put("HSKHAC", hsbaCTRhm.getHsbactrhmSotokhac());
			if (hsbaCTRhm.getHsbactrhmTongsoto() != null)
				params.put("TONGHOSO", hsbaCTRhm.getHsbactrhmTongsoto());
			
			if (hsbaCTRhm.getHsbactrhmNguoigiaoba() != null)
				params.put("NGUOIGIAOHS", hsbaCTRhm.getHsbactrhmNguoigiaoba(true).getDtdmnhanvienTen());
			if (hsbaCTRhm.getHsbactrhmNguoinhanba() != null)
				params.put("NGUOINHANHS", hsbaCTRhm.getHsbactrhmNguoinhanba(true).getDtdmnhanvienTen());
			if (hsbaCTRhm.getHsbactrhmBsdieutri() != null)
				params.put("BASIDT", hsbaCTRhm.getHsbactrhmBsdieutri(true).getDtdmnhanvienTen());
			...
			if(hsbaCTRhm.getHsbactrhmTienluong() != null)
				params.put("TIENLUONG", hsbaCTRhm.getHsbactrhmTienluong());

			String sBSLAMBA = "";
			if (hsbaCTRhm.getHsbactrhmBslamba() != null) {
				sBSLAMBA = hsbaCTRhm.getHsbactrhmBslamba(true).getDtdmnhanvienTen();
			}
			...
			baocao1 = XuatReportUtil.ReportUtil(jasperPrintDT, index,
					IConstantsRes.PATH_BASE
							...
							+ "hsba/", "pdf", "CapNhatThongTinChiTietBARhm");
	...
	public HsbaChiTietRhm getHsbaCTRhm() {
		return hsbaCTRhm;
	}

	public void setHsbaCTRhm(HsbaChiTietRhm hsbaCTRhm) {
		this.hsbaCTRhm = hsbaCTRhm;
	}
