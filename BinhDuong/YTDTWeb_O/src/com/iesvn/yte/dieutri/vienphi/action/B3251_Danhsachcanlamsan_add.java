...
@Scope(SESSION)
public class B3251_Danhsachcanlamsan_add implements Serializable{
	...
	public void save() {
		...
		try {
			this.cls.setDtdmclsChon(true);
			DtDmClsDelegate.getInstance().create(this.cls);
			FacesMessages.instance().add(IConstantsRes.canlamsan_cr_su, ma);
			reset();
		} catch (Exception e) {
			log.error(e.toString());
			FacesMessages.instance().add(IConstantsRes.canlamsan_cr_fa, ma);
		}
	}
