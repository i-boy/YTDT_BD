...
@Name("B3311_Bangkethuchitamungtheongaythuchiriengle")
@Scope(CONVERSATION)
public class Bangkethuchitamungtheongaythuchiriengle implements Serializable {
	@Logger
	private Log log;
	...
	@Out(required=false)
	@In(required=false)
	private String resetFormB3311Thuchiriengle=null;
	...
	@Factory("resetFormB3311Thuchiriengle")
	...
	public String thuchienAction(){
		XuatReport();
		resetFormB3311Thuchiriengle = null;
	...
	public void XuatReport() {
		...
		try {
			...
			if(chonSL.equals("r1")){
				pathTemplate = IConstantsRes.PATH_BASE+IConstantsRes.PATH_REPORT_TEMPLATE_DIEU_TRI+"vienphi/V01_Tinhhinhthutamung.jrxml";
			}else if(chonSL.equals("r2")){
				pathTemplate = IConstantsRes.PATH_BASE+IConstantsRes.PATH_REPORT_TEMPLATE_DIEU_TRI+"vienphi/V01_Tinhhinhchitamung.jrxml";
			}
