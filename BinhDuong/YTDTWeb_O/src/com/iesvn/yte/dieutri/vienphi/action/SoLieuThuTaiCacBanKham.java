...
@Scope(CONVERSATION)
public class SoLieuThuTaiCacBanKham implements Serializable {
	@Logger
	private Log log;
	...
	public void XuatReport() {
		reportTypeVP="V10_PTthucanlamsangbnkhambenh";
		...
		try {	
			...
			Class.forName("oracle.jdbc.OracleDriver");
			    ...
			    baocao1=XuatReportUtil.ReportUtil(jasperPrintVP,index,IConstantsRes.PATH_BASE+IConstantsRes.PATH_REPORT_RESULT_DIEU_TRI+"vienphi/", "pdf","V10_PTthucanlamsangbnkhambenh");
