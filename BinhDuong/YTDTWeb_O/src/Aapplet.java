...
public class Aapplet extends Applet implements Runnable {
	// Define your thread.
	Thread commThread;
...
//		}
	...
	public void pingpong(String str, String portName, String deviceNum){ //str: so thu tu ex. 12345
		//deviceNum = 0 or 1 or .....
		beginOperation(portName);
...
//			os.write("[L0F".getBytes());
	...
	public void outputToLed(String str, String portName, String deviceNum) { // THIS IS EXAMPLE:
...
//			os.write("[L0T".getBytes());
	...
	private void beginOperation(String portName){
		myInitialize(portName);
	}
	private void endOperation(){
		//destroy();
	}
	public void init() {
		System.out.println("thanh - init - do nothing");
		//do nothing
	}
	public void myInitialize(String portName) { // portName = COM1 or something like that
		...
		while (pList.hasMoreElements()) {
			...
			if (cpi.getName() != null && cpi.getName().equals(portName)) {
				break;
			}
		}
