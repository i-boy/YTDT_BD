    ...
    if (window.google && google.gears) {
        ...
        try {
          ...
          //Thuc hien phim tat giup user thuan tien add thuoc hay chon thuoc
           ...
           timer.setTimeout(function(){setOnload();onCompleteGetInfor();},100);
	  ...
	  //alert(7);
		...
		*/
		...
		if (chuyenTuManHinhThuocCLS == "true"){
			...
			//document.getElementById(prefix_component + "DM_KHOA_MA").focus();
			document.getElementById(prefix_component + "CANLAMSANG_KHOA").focus();
		}
...
function setSoBenhAnFocus(){
	var khoaMa = document.getElementById(prefix_component + "CANLAMSANG_KHOA").value;
	if(khoaMa == ""){
		document.getElementById(prefix_component + "CANLAMSANG_KHOA").focus();
	}else{
