...
function init() {
    ...
    if (window.google && google.gears) {
        ...
        try {
			...
			setAttrForCombobox(prefix_component + 'KCBBHYT_MA','DM_BENH_VIEN2_span','DM_BENH_VIEN__2',"getDmBenhVien()", "", "", "");
		   
			setAttrForCombobox(prefix_component + 'DM_KHOI_BHYT_MA','DM_KHOI_BHYT_span', 'DT_DM_KHOI_BHYT',"getDtDmKhoiBhyt()","", "focusToKcbBhyt();", "");
...
function checkForGioi(){
	...
	if (valueTen != null && valueTen != "" && ( valueTen.indexOf(thi_1) >= 0 || valueTen.indexOf(thi_2) >= 0)){
		...
		//alert( document.getElementById(prefix_component + "gioitinh:1"));
		document.getElementById(prefix_component + "gioitinh:1").checked = true;
...
function setDmTangFocus(){
	...
	if(khoaMa == ""){
		...
		document.getElementById(prefix_component + "DM_TANGcomboboxField").focus();
	}	
}
