...
function blockInphieu() {
	...
	if (document.getElementById(prefix_component + "hid_hienThiInPhieu").value == 'false') {
		document.getElementById("__divIn").style.display = "none";
	} else {
		document.getElementById("__divIn").style.display = "block";
	}
	
	if (document.getElementById(prefix_component + "hid_hienThiGhiNhan").value == 'false') {
...
function onCompleteGetInfor(){
	...
	blockInphieu();
	//document.getElementById(prefix_component + "__maphieu").select();
