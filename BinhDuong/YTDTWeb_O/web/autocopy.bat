...
rem autocopy.bat "C:\Users\ies\AppData\LocalLow\Google\Google Gears for Internet Explorer\localhost\http_8088\database-Quan_Ly_Y_Te#database" "\\10.0.0.12\ShareFiles\BAO.TTC" "/user:10.0.0.12\bao-ttc 12345678"
