...
@Table(name = "THUOC_DONG_Y_NGOAI_TRU")
@NamedQueries({
    @NamedQuery(name = "ThuocDongYNgoaiTru.findAll", query = "SELECT t FROM ThuocDongYNgoaiTru t")})
public class ThuocDongYNgoaiTru implements Serializable {
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "THUOC_DONG_Y_NGOAI_TRU")
    @SequenceGenerator(name = "THUOC_DONG_Y_NGOAI_TRU", sequenceName = "THUOC_DONG_Y_NGOAI_TRU_THUOCDO", allocationSize = 1)
    ...
    @JoinColumn(name = "THUOCDONGY_THAMKHAM", referencedColumnName = "THAMKHAM_MA")
    @ManyToOne (fetch=FetchType.LAZY)
    private ThamKham thuocdongyThamkham;

    public ThuocDongYNgoaiTru() {
    }

    public ThuocDongYNgoaiTru(Integer thuocdongyMaso) {
        this.thuocdongyMaso = thuocdongyMaso;
    }

    public ThuocDongYNgoaiTru(Integer thuocdongyMaso, double thuocdongySoluong, double thuocdongyDongia) {
        this.thuocdongyMaso = thuocdongyMaso;
    ...
    public ThamKham getThuocdongyThamkham(boolean create) {
        if(create && getThuocdongyThamkham() == null) setThuocdongyThamkham(new ThamKham());
        return  getThuocdongyThamkham();
    }
    public ThamKham getThuocdongyThamkham() {
        return thuocdongyThamkham;
    }

    public void setThuocdongyThamkham(ThamKham thuocdongyThamkham) {
        this.thuocdongyThamkham = thuocdongyThamkham;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ThuocDongYNgoaiTru)) {
            return false;
        }
        ThuocDongYNgoaiTru other = (ThuocDongYNgoaiTru) object;
    ...
    public String toString() {
        return "com.iesvn.yte.dieutri.entity.ThuocDongYNgoaiTru[thuocdongyMaso=" + thuocdongyMaso + "]";
    }
