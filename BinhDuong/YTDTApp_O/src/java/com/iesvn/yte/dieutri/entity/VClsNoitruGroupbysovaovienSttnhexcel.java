...
@Table(name = "V_CLS_NOITRU_GBSOVAOVIEN_STTNH")
@NamedQueries({
    @NamedQuery(name = "VClsNoitruGroupbysovaovienSttnhexcel.findAll", query = "SELECT v FROM VClsNoitruGroupbysovaovienSttnhexcel v")})
public class VClsNoitruGroupbysovaovienSttnhexcel implements Serializable {
    ...
    public VClsNoitruGroupbysovaovienSttnhexcel() {
    }
