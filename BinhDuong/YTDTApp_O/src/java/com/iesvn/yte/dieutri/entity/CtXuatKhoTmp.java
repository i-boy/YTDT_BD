...
@Table(name = "CT_XUAT_KHO_TMP")
@NamedQueries({
    @NamedQuery(name = "CtXuatKhoTmp.findAll", query = "SELECT c FROM CtXuatKhoTmp c")})
public class CtXuatKhoTmp implements Serializable {
    private static final long serialVersionUID = 1L;
    @Id
    @Column(name = "CTXUATKHO_MA")
    ...
    public CtXuatKhoTmp(Integer ctxuatkhoMa) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CtXuatKhoTmp)) {
            return false;
        }
        CtXuatKhoTmp other = (CtXuatKhoTmp) object;
    ...
    public String toString() {
        return "com.iesvn.yte.dieutri.entity.CtXuatKhoTmp[ctxuatkhoMa=" + ctxuatkhoMa + "]";
    }
