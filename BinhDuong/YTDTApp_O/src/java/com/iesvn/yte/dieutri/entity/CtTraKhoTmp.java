...
@Table(name = "CT_TRA_KHO_TMP")
@NamedQueries({})
public class CtTraKhoTmp implements Serializable {
...
//    @SequenceGenerator(name = "CT_TRA_KHO_CTTRAKHO_MA", sequenceName = "CT_TRA_KHO_CTTRAKHO_MA_SEQ", allocationSize = 1)
    ...
    public CtTraKhoTmp(Integer cttrakhoMa) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CtTraKhoTmp)) {
            return false;
        }
        CtTraKhoTmp other = (CtTraKhoTmp) object;
    ...
    public String toString() {
        return "com.iesvn.yte.dieutri.entity.CtTraKhoTmp[cttrakhoMa=" + cttrakhoMa + "]";
    }
